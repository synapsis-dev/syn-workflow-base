 ...
 * @template T
 */
export interface IElementDefinition<T extends ElementType> extends IDisabledElementDefinition, IReadonlyElementDefinition, IRequiredElementDefinition, IValueElementDefinition<T>, IVisibleElementDefinition {
